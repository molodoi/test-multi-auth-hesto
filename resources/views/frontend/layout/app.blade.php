                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="">{{ __('Espace Ecole') }}</a>
                            </li>
                            ...
                            {{-- <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.login.get') }}">{{ __('Admin Login') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.register.get') }}">{{ __('Admin Register') }}</a>
                            </li> --}}
                        @else
